...
POLYMARKET_MIN_EDGE_PCT = float(os.getenv("POLYMARKET_MIN_EDGE_PCT", "5.0"))
...
PM_STARS_2_EDGE = float(os.getenv("PM_STARS_2_EDGE", "5"))    # = порог входа
PM_STARS_3_EDGE = float(os.getenv("PM_STARS_3_EDGE", "8"))
PM_STARS_4_EDGE = float(os.getenv("PM_STARS_4_EDGE", "12"))
# Начиная с этой ступени требуем, чтобы влез полный размер.
PM_STARS_FULL_SIZE_FROM = int(os.getenv("PM_STARS_FULL_SIZE_FROM", "3"))
# И чтобы наш собственный сигнал был не слабее этого, для верхней ступени.
PM_STARS_4_MIN_BASE = int(os.getenv("PM_STARS_4_MIN_BASE", "3"))
